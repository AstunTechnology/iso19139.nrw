<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="/record">
      <xsl:variable name="cataloglang" select="'eng'"></xsl:variable>
      ...
      <mdb:MD_Metadata xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
          ...
          <mcc:MD_Identifier>
            <mcc:code>
              <gco:CharacterString>
                ...
                <xsl:message>=== <xsl:value-of select="uuid"/> ===</xsl:message>
                <xsl:message>=== <xsl:value-of select="dct:title"/> ===</xsl:message>
              </gco:CharacterString>
            </mcc:code>
          </mcc:MD_Identifier>
        </mdb:metadataIdentifier>
        ...
        <mdb:dateInfo>
          <xsl:message>=== issued: <xsl:value-of select="issued"/> ===</xsl:message>
          <xsl:message>=== modified: <xsl:value-of select="modified"/> ===</xsl:message>
          <cit:CI_Date>
            <cit:date>
              <gco:DateTime>1998-01-01T00:00:00</gco:DateTime>
            </cit:date>
            <cit:dateType>
