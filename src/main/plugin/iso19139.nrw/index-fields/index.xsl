...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="gmi:MI_Metadata|gmd:MD_Metadata|*[@gco:isoType='gmd:MD_Metadata']"
    ...
    <xsl:variable name="identifier" as="xs:string?"
                  select="/gmd:MD_Metadata/gmd:identificationInfo/*/gmd:citation/gmd:CI_Citation/gmd:identifier/*/gmd:code/gco:CharacterString[. != '']"/>
    ...
    gmd:title/(gco:CharacterString|gmx:Anchor)">
      ...
      <xsl:for-each select="gmd:distributionInfo/*">
        ...
        <xsl:for-each
          select="gmd:distributionFormat/gmd:MD_Format/gmd:specification/gco:CharacterString/text()[. != '']">
